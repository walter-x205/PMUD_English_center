...
<!-- 						<button type="submit" id="btnSearch" name="btnSearch" value="Search"  class="btn btn-outline-primary"><i class="fas fa-search fa-fw"></i></button> -->
					...
					<div>
						<a class="btn btn-primary mb-1" href="${base }/addNewTeacher" role="button"><i class="fas fa-plus"></i> Thêm giảng viên mới</a>
					</div>
				</div>
...
<%-- 									<td><img src="dist/img/${o.photo }" class="img-circle " alt="User Image"></td> --%>
									...
									<td class="d-flex">
										...
										<button class="btn btn-outline-primary btn-sm py-2 form-control w-40" name="delete_btn" onclick="deleteTeacherToTeacherList(this,${o.teacherID});" type="button"><i class="fas fa-trash-alt"></i></button>
									</td>
								</tr>
							</tbody>
						</c:forEach>
