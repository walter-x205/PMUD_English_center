					...
					<form  id="form_addNewStudent" name="form_addNewStudent" action="${base}/addNewStudent" method="POST">
						...
						<div class="row mx-auto">
							...
							<div class="col-md-12">
								<div class="md-form mb-4">
									...
									<textarea class="form-control" id="qualification" name="qualification" rows="5"></textarea>
								</div>
							</div>
							<!--Grid column-->
						</div>
						<div class="row w-75 mx-auto my-4">
							<div class="col-12 text-center">	
								<a class="btn btn-primary w-25" onclick="addNewTeacher();" role="button" >Thêm giảng viên</a>
							</div>
						</div>
					</form>			
				</div>
