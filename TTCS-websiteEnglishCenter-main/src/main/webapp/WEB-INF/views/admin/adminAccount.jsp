						...
						<div
							...
							<div class="position-relative" style="display: flex;">
								<input class="form-control w-100"
									placeholder="Search ...">
								<button class="btn text-light bg-secondary ms-1"
									id="btnNavbarSearch">
							...
							<c:if test="${sessionScope.admin.role == 'ADMIN' }">
								<div class="px-2">
									<a href="${base }/addNewAccountStaff" type="button"
										class="btn btn-secondary add-button"> <i
										class="fas fa-plus"></i> Thêm tài khoản mới
									</a> <i class="fa fa-ellipsis-h ms-3"></i>
								</div>
							</c:if>
						</div>
