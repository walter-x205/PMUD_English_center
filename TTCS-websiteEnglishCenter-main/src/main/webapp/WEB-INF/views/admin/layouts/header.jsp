...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
	<!-- Navbar Brand-->
	<a class="navbar-brand ps-3 simple-text mx-3" href="test.html"><img
	...
	<!-- <li class="nav-item dropdown mr-1 mb-4"><a
		...
		<div class="dropdown-menu">
			<a class="dropdown-item d-flex align-items-start" href="#">
				...
				<div class="text pl-3">
					<h4>
						Tue<span> add thêm task mới</span>
					</h4>
					<span class="time">m min ago</span>
				</div>
			</a> <a class="dropdown-item d-flex align-items-start" href="#">
				<div class="img" style="background-image: url();"></div>
				<div class="text pl-3">
					<h4>
						Tue <span> update khóa học </span>
					</h4>
					<span class="time">m min ago</span>
				</div>
			</a> <a class="dropdown-item d-flex align-items-start" href="#">
	...
	<form
		...
		<div class="input-group">
			...
			<button class="btn text-secondary bg-light" id="btnNavbarSearch"
				type="button">
	...
	<ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			aria-expanded="false"><i class="fas fa-user fa-fw"></i>${sessionScope.admin.name }</a>
			<ul class="dropdown-menu dropdown-menu-end"
				aria-labelledby="navbarDropdown">
				<li><a class="dropdown-item" href="profile.html">Settings</a></li>
				<li><a class="dropdown-item" href="#!">Activity Log</a></li>
				<li><hr class="dropdown-divider" /></li>
				<li><a class="dropdown-item" href="${base}/ad-logout">Logout</a></li>
			</ul></li>
	</ul>
</nav>