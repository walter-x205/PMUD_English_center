		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb py-1">
				<li class="breadcrumb-item"><a href="./homepage.html">Trang
						chủ</a></li>
				<li class="breadcrumb-item active" aria-current="page">Lớp giảng dạy</li>
			</ol>
		</nav>
		<hr>
		<div class="p-5">
			<div class="title_form">
					<h2 class="m-0">Danh sách lớp giảng dạy</h2>
				</div>
						...
						<c:forEach items="${cList }" var="o">
							<tbody>
								<tr>
									...
									<td>${o.startDate}</td>
									<td class="d-flex"> 		
										<a class="btn btn-outline-primary btn-sm py-2 form-control w-40" href="${base }/infoClass?id=${o.idClass}"  ><i class="fas fa-edit"></i></a>
